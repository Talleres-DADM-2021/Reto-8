    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAgregar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getApplicationContext(),"Empresa Adicionada",Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnEliminar.setOnClickListener(new View.OnClickListener() {    //falta agregar el confirmation system y sale
            ...
            public void onClick(View v) {
                ...
                dialog.setMessage("Esta acción elimina una empresa de la lista ¿Esta seguro de continuar?");
